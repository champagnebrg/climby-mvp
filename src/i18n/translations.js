...
const adminEventFallbacks = {
    ...
    eventsSectionCompetitionHint: { it: 'Configura la gara live in modo chiaro, senza duplicare dati non necessari.', en: 'Configure live competition clearly, without duplicating unnecessary data.' },
    ...
    eventsCompetitionStatusDraft: { it: 'Bozza', en: 'Draft' },
    eventsCompetitionStatusLive: { it: 'Live', en: 'Live' },
    eventsCompetitionStatusClosed: { it: 'Chiusa', en: 'Closed' },
